...
import com.shenyuan.superapp.base.databinding.DialogSimpleEditBinding;
 ...
 * desc
 */
public class SimEditDialog extends BaseDialog<DialogSimpleEditBinding> {

    public SimEditDialog(@NonNull Context context) {
        super(context);
    }
    ...
    public static class Builder {
        ...
        public SimEditDialog build() {
            if (context == null) {
                return null;
            }
            SimEditDialog simDialog = new SimEditDialog(context);
