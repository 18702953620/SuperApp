 ...
 * desc
 */
public class HomeStudentRefreshHeader extends LinearLayout implements RefreshHeader {
    private ImageView ivBaseRefresh;
    private RotateAnimation rotateAnimation;

    public HomeStudentRefreshHeader(Context context) {
        super(context);
        initHead(context);
    }

    public HomeStudentRefreshHeader(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initHead(context);
    }

    public HomeStudentRefreshHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initHead(context);
    }

    private void initHead(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.home_student_refresh_head, this);
