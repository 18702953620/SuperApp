 ...
 * desc 基类
 */
public abstract class BaseStuActivity<B extends ViewDataBinding, P extends BasePresenter> extends AppCompatActivity implements BaseView {
    /**
     * context
     */
    ...
    private void showLoadingDialog() {
        if (loadingView == null) {
            ...
            loadingView.setImageResource(R.mipmap.stu_loading);
        }
    ...
    public void showLoginDialog() {
        new SimStudentDialog.Builder(context).submitText(getString(R.string.to_login)).title(getString(R.string.need_login))
