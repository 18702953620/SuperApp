 ...
 * desc 区域
 */
public class AreaAdapter extends SearchMultpleAdapter<AreaBean> {
    public AreaAdapter(@Nullable List<AreaBean> data) {
        super(data);
    }

    @Override
    protected void convert(@NotNull BaseDataBindingHolder baseDataBindingHolder, AreaBean s) {
        ...
        if (multpleBinding != null) {
            multpleBinding.tvMultpleText.setText(s.getAreaName());
        }
    }
}
