 ...
 * desc 招生层次
 */
public class StudentLevelWindow extends BasePopupWindow<PopSchoolSortBinding, StudentCommonPresenter> implements StudentCommonView {
    private BaseQuickAdapter<SimpleBean, BaseDataBindingHolder> sortAdapter;
    private int sortPosition = -1;
    private OnSortBack onBack;

    public StudentLevelWindow(Context context) {
