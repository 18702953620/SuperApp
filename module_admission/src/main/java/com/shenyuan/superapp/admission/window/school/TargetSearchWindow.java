...
public class TargetSearchWindow extends BasePopupWindow<PopTargetSchoolSearchBinding, SchoolCommonPresenter> implements CommonView {
    ...
    protected void initView() {
        ...
        //分配人列表
        presenter.getDisNameList();
        binding.tvCreate.setText("分配人列表");
        ...
        binding.tvSubmit.setOnClickListener(v1 -> {
            ...
            if (onBack != null) {
                onBack.onBack(areaId, areaStaffId, isListed, null, createId);
            }
        });
     ...
     */
    private void resetSearchState(PopTargetSchoolSearchBinding popBinding) {
