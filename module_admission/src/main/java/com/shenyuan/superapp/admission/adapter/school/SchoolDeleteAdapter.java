 ...
 * desc
 */
public class SchoolDeleteAdapter extends BaseVBAdapter<SchoolListBean, BaseDataBindingHolder> {

    public SchoolDeleteAdapter() {
    ...
    protected void convert(@NotNull BaseDataBindingHolder holder, SchoolListBean sm) {
        ...
        bi.ivSchoolState.setVisibility(View.VISIBLE);
        //名称
