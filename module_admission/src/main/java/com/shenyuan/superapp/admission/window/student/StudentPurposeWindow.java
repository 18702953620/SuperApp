 ...
 * desc 生源意向
 */
public class StudentPurposeWindow extends BasePopupWindow<PopSchoolSortBinding, StudentCommonPresenter> implements StudentCommonView {
    private BaseQuickAdapter<SimpleBean, BaseDataBindingHolder> sortAdapter;
    private int sortPosition = -1;
    private OnSortBack onBack;

    public StudentPurposeWindow(Context context) {
