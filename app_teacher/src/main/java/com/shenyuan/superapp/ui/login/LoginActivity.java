...
import com.shenyuan.superapp.databinding.ItemLoginAccountBinding;
import com.shenyuan.superapp.databinding.PopLoginAccountBinding;
 ...
 * desc 登录页
 */
@Route(path = ARouterPath.AppTeacher.APP_LOGIN)
public class LoginActivity extends BaseActivity<AcLoginBinding, LoginPresenter> implements LoginView {
    ...
    protected void initView() {
        ...
        style.setSpan(new ForegroundColorSpan(getValuesColor(R.color.color_0077ff)), 7, 13, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        style.setSpan(new ForegroundColorSpan(getValuesColor(R.color.color_0077ff)), 14, text.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public void onGetUser(HashMap<String, String> o) {
        if (o != null) {
            ...
            if (!TextUtils.isEmpty(tel)) {
                ARouter.getInstance().build(ARouterPath.AppTeacher.APP_FORGOT_PASSWORD)
