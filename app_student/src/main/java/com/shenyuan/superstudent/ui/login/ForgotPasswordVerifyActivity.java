...
import com.shenyuan.superstudent.databinding.AcForgotPasswordVerifyBinding;
 ...
 * desc 验证码
 */
@Route(path = ARouterPath.AppStudent.APP_STUDENT_FORGOT_PASSWORD_VERIFY)
public class ForgotPasswordVerifyActivity extends BaseStuActivity<AcForgotPasswordVerifyBinding, PasswordPresenter> implements PasswordView {
    @Autowired
    public String tel;
    ...
    public void onVerifyCode(String o) {
        ARouter.getInstance().build(ARouterPath.AppStudent.APP_STUDENT_FORGOT_PASSWORD_MESSAGE)
