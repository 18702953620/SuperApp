...
import com.shenyuan.superstudent.databinding.AcEditPasswordBinding;
 ...
 * desc 修改密码
 */
@Route(path = ARouterPath.AppStudent.APP_STUDENT_EDIT_PASSWORD)
public class EditPasswordActivity extends BaseStuActivity<AcEditPasswordBinding, PasswordPresenter> implements PasswordView {
    @Override
