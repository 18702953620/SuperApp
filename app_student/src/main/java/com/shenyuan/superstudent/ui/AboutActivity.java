...
import com.shenyuan.superstudent.databinding.AcAboutUsBinding;
 ...
 * desc 关于我们
 */
@Route(path = ARouterPath.AppStudent.APP_STUDENT_ABOUTUS)
public class AboutActivity extends BaseStuActivity<AcAboutUsBinding, BasePresenter> {
    @Override
