 ...
 * desc 需要继承 JPush 提供的 JPushMessageReceiver
 */
    ...
    public void onNotifyMessageOpened(Context context, NotificationMessage message) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(extra)) {
                HashMap<String, String> map = JSONObject.parseObject(extra, HashMap.class);
                ...
                if (!TextUtils.isEmpty(id)) {
                    if (TextUtils.isEmpty(TokenCommon.getToken())) {
                        ...
                        ARouter.getInstance().build(ARouterPath.Common.COMMON_WEB).withString("msgId", id).navigation();
                    }
                }
            }
