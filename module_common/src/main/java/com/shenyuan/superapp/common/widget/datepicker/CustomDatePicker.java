...
public class CustomDatePicker {
    ...
    private TextView tvCancle, tvSelect;
    ...
    private void initParameter() {
        ...
        endYear = endCalendar.get(Calendar.YEAR) + 3;
     ...
     * 2019-8-19 levent
     */
    public void showYearMonthDay(boolean show) {
        if (canAccess) {
            if (show) {
//                disScrollUnit();
                year_pv.setVisibility(View.VISIBLE);
...
//                disScrollUnit(SCROLL_TYPE.HOUR, SCROLL_TYPE.MINUTE);
    ...
    public void setSelectedTime(String time) {
        if (canAccess) {
            ...
            String data = str[0];
            Log.d("tttt", data.substring(0, 4) + "," + data.substring(5, 7) + "," + data.substring(8));
            ...
            day_pv.setData(day);
            day_pv.setSelected(data.substring(8) + "日");
