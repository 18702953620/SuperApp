...
@Route(path = ARouterPath.Common.COMMON_NET_ERROR_STUDENT)
public class NetErrorStuActivity extends BaseActivity<AcNetErrorBinding, BasePresenter> {
    @Override
    ...
    protected int getLayoutId() {
        return R.layout.ac_net_error_student;
    }
